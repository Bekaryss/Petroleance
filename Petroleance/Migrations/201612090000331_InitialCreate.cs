namespace Petroleance.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        TriviaTests_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.TriviaTests", t => t.TriviaTests_Id)
                .Index(t => t.TriviaTests_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.TriviaQuestions", "TriviaTests_Id", "dbo.TriviaTests");
            DropIndex("dbo.TriviaQuestions", new[] { "TriviaTests_Id" });
